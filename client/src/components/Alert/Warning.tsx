export default function Warnings({ onClick, onCancel }: any) {
    return (
        <div className="bg-warning h-[300px] sm:[58vh] w-[400px] bg-opacity-10 m-auto py-40 sm:py-0 flex items-center justify-center flex-col gap-2">
